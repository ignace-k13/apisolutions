...
import be.abis.exercise.form.LoginRecord;
...
public class PersonController {
	...
	@PostMapping("/login2")
	public Person findPersonByMailAndPwd(@RequestBody LoginRecord login){
		Person p = ps.findPerson(login.email(), login.password());
		return p;
	}
